...
const recentResults: ResultYear[] = [
  ...
  { year: '2023', label: '2023', link: '/race-results/2023 BAWRA Results.xlsx' },
  { year: '2022', label: '2022', link: '/race-results/2022 BAWRA Results.xlsx' },
  { year: '2021', label: '2020, 2021 Covid Pandemic', link: '#', isExternal: true },
];

// Group 2: 2010-2019
const results2010s: ResultYear[] = [
  { year: '2019', label: '2019', link: '/race-results/2019 BAWRA Results.xlsx' },
  { year: '2018', label: '2018', link: '/race-results/2018 BAWRA Results.xlsx' },
  { year: '2017-2', label: '2017 Fall', link: '/race-results/2017 BAWRA FALL Results1.xlsx' },
  { year: '2017-1', label: '2017 Spring (except Alcatraz, B2B)', link: '/race-results/2017 BAWRA Results.xlsx' },
  { year: '2016', label: '2016', link: '/race-results/2016 BAWRA Results.xlsx' },
  { year: '2015', label: '2015', link: '/race-results/2015 BAWRA Results.xlsx' },
  { year: '2014', label: '2014', link: '/race-results/2014 BAWRA Results.xlsx' },
  { year: '2013', label: '2013', link: '/race-results/2013 BAWRA Results.xlsx' },
  { year: '2012-2', label: '2012 Fall', link: '/race-results/2012 BAWRA SW - Fall Results.xlsx' },
  { year: '2012-1', label: '2012 Spring (except B2B)', link: '/race-results/2012 Spring except B2B.pdf' },
  { year: '2012-b2b', label: '2012 B2B', link: '/race-results/2012 B2B.jpg' },
  { year: '2011', label: '2011', link: '/race-results/2011 BAWRA Results.xls' },
  { year: '2010-erc', label: '2010 ERC-STP', link: '/race-results/2010 BAWRA erc-stp.pdf' },
  { year: '2010-hoe', label: '2010 HOE', link: '/race-results/2010 HOE.jpg' },
  { year: '2010-fall', label: '2010 Fall Championships', link: '/race-results/2010 Fall Season Champ.jpg' },
  { year: '2010-spring', label: '2010 Spring (except B2B)', link: '/race-results/2010 BAWRA Spring Results except b2b.pdf' },
];

// Group 3: 2000-2009
const results2000s: ResultYear[] = [
  { year: '2009', label: '2009 (except B2B)', link: '/race-results/2009 BAWRA Results.xls' },
  { year: '2008', label: '2008 (except B2B)', link: '/race-results/2008 BAWRA Results.xlsx' },
  { year: '2007', label: '2007', link: '/race-results/2007 BAWRA Results.xls' },
  { year: '2006', label: '2006 (except B2B)', link: '/race-results/2006 BAWRA Results except b2b.xls' },
  { year: '2005', label: '2005 Spring (Partial Alcatraz) and STP, HOE', link: '/race-results/2005 Spring - partial Alcatraz - and STP-HOE.xlsx' },
  { year: '2004', label: '2004 Alcatraz, CGC, HOE', link: '/race-results/2004 spring alcatraz and cgc.docx' },
  { year: '2003', label: '2003 Spring', link: '/race-results/2003 Spring Standings 2003.xls' },
  { year: '2002', label: '2002 Spring (except B2B) and HOE', link: '/race-results/2002 BAWRA Spring less B2B plus HOE.xls' },
  { year: '2001-lane', label: '2001 Lane Draws', link: '/race-results/2001 Lane Draws.pdf' },
  { year: '2001-alc', label: '2001 Alcatraz', link: '/race-results/2001 Alcatraz.pdf' },
  { year: '2001-cgc', label: '2001 CGC', link: '/race-results/2001 BAWRA CGC Results.doc' },
  { year: '2001-b2b', label: '2001 B2B', link: '/race-results/2001 bridge to bridge.pdf' },
  { year: '2000', label: '2000 Spring (except B2B)', link: '/race-results/2000 spring (except b2b).pdf' },
];

// Group 4: 1990-1999
const results1990s: ResultYear[] = [
  { year: '1999', label: '1999', link: '/race-results/1999 BAWRA results.pdf' },
  { year: '1998', label: '1998 B2B', link: '/race-results/1998 B2B.png' },
  { year: '1997', label: '1997 Spring', link: '/race-results/1997 spring.pdf' },
  { year: '1996', label: '1996 Spring', link: '/race-results/1996 Spring.png' },
  { year: '1995', label: '1995 Spring', link: '/race-results/1995 Spring.pdf' },
  { year: '1994', label: '1994 Spring (except CGC, B2B)', link: '/race-results/1994 Spring except CGC and B2B.pdf' },
  { year: '1993', label: '1993 B2B', link: '/race-results/1993 B2B Results.pdf' },
  { year: '1992-spring', label: '1992 Spring Results', link: '/race-results/1992 Spring Results.pdf' },
  { year: '1992-b2b', label: '1992 B2B Times', link: '/race-results/1992 B2B Times.pdf' },
  { year: '1991', label: '1991 Alcatraz', link: '/race-results/1991 Alcatraz.pdf' },
  { year: '1990', label: '1990 Spring', link: '/race-results/1990 BAWRA Spring Results.pdf' },
];
